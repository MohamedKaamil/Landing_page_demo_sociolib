  ...
  return (
    <section className="relative py-14 bg-primary text-white overflow-hidden">
      ...
      <Image
        ...
        alt="CTA background"
        fill
        className="object-cover opacity-100 py-0 lg:px-20 bg-white z-10 "
      />
      <div className="container mx-auto lg:px-30 px-8 flex flex-col md:flex-row items-center justify-between gap-8 relative z-20">
        <motion.h2
        ...
        >
          <Link
            href="#process"
            className="inline-flex items-center justify-center bg-yellow-400 text-gray-900 px-8 py-4 rounded-lg font-semibold hover:bg-yellow-500 transition"
          >
